...
| V7 | G-73 (spec conflict) | Mockup `06-halo.html:1056` inline-styles the Codex CTA cool-blue (`#7ec9ff→#4aa3df`) and its E3 caption says "a cool-blue jump-to-approve"; plan + gap row spec amber. Implemented amber per plan (judge PASS); `.codex-note` panel stays cool-blue | Mockup and plan contradict each other — owner should reconcile the board or bless the amber |
